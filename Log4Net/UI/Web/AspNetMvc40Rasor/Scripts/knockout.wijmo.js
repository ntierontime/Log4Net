    ...
    ko.wijmo.customBindingFactory = function () {
        ...
        self.customBinding = function (options) {
            ...
            binding.init = function (element, valueAccessor, allBindingAccessor, viewModel) {
                ...
                widget = $(element)[widgetName](opts).data(namespace + widgetName.charAt(0).toUpperCase() + widgetName.substr(1));
            ...
            equals = function (sourceValue, targetValue) {
                ...
                if ($.isPlainObject(sourceValue)) {
                    if (sourceValue.constructor !== Object.prototype.constructor || targetValue !== Object.prototype.constructor) {
                        return false;
                    }
                    equal = true;
