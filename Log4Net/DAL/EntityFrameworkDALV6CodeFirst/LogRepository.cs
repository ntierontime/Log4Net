...
namespace Log4Net.EntityFrameworkDAL
{
    ...
    public class LogRepository
        : Log4Net.DALContracts.ILogRepository//<Log4Net.DataSourceEntities.LogCollection, Log4Net.DataSourceEntities.Log, Log4Net.DataSourceEntities.LogIdentifier>
    {
        #region for log4net
        ...
        public LogRepository(Log4Net.EntityFrameworkContext.Log4NetEntities linqContext)
        {
            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    select new Framework.RssItem { Title = t.Thread, Description = t.Thread, PubDate = t.Date, IdentifierInString = _IdentifierInString } into vD1
                    select vD1
                );
            var _retval = _ResultFromDataSource;
            ...
            )
        {
            var _ResultFromDataSource =
                (
                    ...
                    select new Log4Net.DataSourceEntities.Log.KeyInformation { Id = t.Id, Thread = t.Thread } into vD2
                    select vD2
                );
            var _retval = _ResultFromDataSource;
