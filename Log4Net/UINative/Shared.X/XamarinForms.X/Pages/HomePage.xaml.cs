...
namespace Log4Net.XamarinForms.Pages {
    public partial class HomePage : ContentPage {
        ...
        private static void InitializeNavigationSettingCollectionInMainViewModel()
        {
            ...
            Log4Net.MVVMLightViewModels.ViewModelLocator.MainStatic.NavigationSettingCollection.Add(Log4Net.MVVMLightViewModels.ItemVMLog.EntityName_Static, Log4Net.MVVMLightViewModels.ItemVMLog.ViewName_Details, Framework.UIAction.Copy,  Framework.UIActionStatus.Launch, Framework.UIAction.Navigate, "/Pages/BuildEventCode/Create.xaml", typeof(Log4Net.XamarinForms.Pages.Log.Create));
