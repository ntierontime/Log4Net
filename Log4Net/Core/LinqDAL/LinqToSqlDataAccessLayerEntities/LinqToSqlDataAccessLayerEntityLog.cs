...
namespace Log4Net.LinqDAL
{
    ...
    /// 3. Queries
    /// </summary>
    public class LinqToSqlDataAccessLayerEntityLog
        : Log4Net.DALContracts.DataAccessLayerEntityContractLog//<Log4Net.DataSourceEntities.LogCollection, Log4Net.DataSourceEntities.Log, Log4Net.DataSourceEntities.LogIdentifier>
    {
        ...
        /// </summary>
        public Log4Net.LinqToSqlContexts.Log4NetContext LinqContext { get; set; }
        ...
        /// </summary>
        public LinqToSqlDataAccessLayerEntityLog()
        {
        }
        ...
        /// </summary>
        /// <param name="linqContext">see<see cref="Log4Net.LinqToSqlContexts.Log4NetContext"/></param>
        public LinqToSqlDataAccessLayerEntityLog(Log4Net.LinqToSqlContexts.Log4NetContext linqContext)
        {
        ...
        public Log4Net.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionLog Insert(Log4Net.DataSourceEntities.Log input)
        {
            ...
            if (input != null)
            {
                Log4Net.LinqToSqlContexts.Log _LinqItem = Log4Net.EntityContracts.ILogHelper.Clone<Log4Net.DataSourceEntities.Log, Log4Net.LinqToSqlContexts.Log>(input);
                this.LinqContext.Log.InsertOnSubmit(_LinqItem);
                this.LinqContext.SubmitChanges();
                Log4Net.DataSourceEntities.Log _Result = new Log4Net.DataSourceEntities.Log();
                Log4Net.EntityContracts.ILogHelper.Copy<Log4Net.LinqToSqlContexts.Log, Log4Net.DataSourceEntities.Log>(_LinqItem, _Result);
        ...
        public Log4Net.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionLog Update(Log4Net.DataSourceEntities.Log input)
        {
            ...
            if (input != null)
            {
                Log4Net.LinqToSqlContexts.Log _LinqItem = GetLinqObjectByIdentifier(input);
                if (_LinqItem != null)
                {
                    //Log4Net.EntityContracts.ILogHelper.Copy<Log4Net.DataSourceEntities.Log, Log4Net.LinqToSqlContexts.Log>(input, _LinqItem);
                    _LinqItem.Id = input.Id;
                    _LinqItem.Date = input.Date;
                    _LinqItem.Thread = input.Thread;
                    _LinqItem.Level = input.Level;
                    _LinqItem.Logger = input.Logger;
                    _LinqItem.Message = input.Message;
                    _LinqItem.Exception = input.Exception;
                    this.LinqContext.SubmitChanges();
					Log4Net.DataSourceEntities.Log _Result = new Log4Net.DataSourceEntities.Log();
					Log4Net.EntityContracts.ILogHelper.Copy<Log4Net.LinqToSqlContexts.Log, Log4Net.DataSourceEntities.Log>(_LinqItem, _Result);
					_retval.Result = new Log4Net.DataSourceEntities.LogCollection();
        ...
        public Log4Net.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionLog Delete(Log4Net.DataSourceEntities.Log input)
        {
            ...
            if (input != null)
            {
                ...
                if (_LinqItem != null)
                {
                    this.LinqContext.Log.DeleteOnSubmit(_LinqItem);
                    this.LinqContext.SubmitChanges();
                }
            }
        ...
        public Log4Net.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionLog DeleteByIdentifier(Log4Net.DataSourceEntities.LogIdentifier id)
        {
            ...
            if (id != null)
            {
                Log4Net.LinqToSqlContexts.Log _LinqItem = GetLinqObjectByIdentifier(id);
                if (_LinqItem != null)
                {
					Log4Net.DataSourceEntities.Log _Original = new Log4Net.DataSourceEntities.Log();
					Log4Net.EntityContracts.ILogHelper.Copy<Log4Net.LinqToSqlContexts.Log, Log4Net.DataSourceEntities.Log>(_LinqItem, _Original);
...
/*
            ...
            if (input != null)
            {
                List<Log4Net.LinqToSqlContexts.Log> _ListOfLinq = Log4Net.EntityContracts.ILogHelper.CloneCollection
                    <
                        Log4Net.DataSourceEntities.LogCollection, List<Log4Net.LinqToSqlContexts.Log>,
                        Log4Net.DataSourceEntities.Log, Log4Net.LinqToSqlContexts.Log
                    >(input);
                this.LinqContext.Log.InsertAllOnSubmit<Log4Net.LinqToSqlContexts.Log>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
                for (int i = 0; i < input.Count; i++)
                {
                    Log4Net.EntityContracts.ILogHelper.Copy
                        <
                            Log4Net.LinqToSqlContexts.Log, Log4Net.DataSourceEntities.Log
...
*/
        ...
        public Log4Net.DataSourceEntities.DataAccessLayerMessageOfEntityCollectionLog BatchDelete(Log4Net.DataSourceEntities.LogCollection input)
        {
            ...
            if (input != null)
            {
                List<Log4Net.LinqToSqlContexts.Log> _ListOfLinq = new List<Log4Net.LinqToSqlContexts.Log>();
                foreach (Log4Net.DataSourceEntities.Log _ItemOfInput in input)
                {
                    Log4Net.LinqToSqlContexts.Log _LinqItem = GetLinqObjectByIdentifier(_ItemOfInput);
                    Log4Net.EntityContracts.ILogHelper.Copy<Log4Net.DataSourceEntities.Log, Log4Net.LinqToSqlContexts.Log>(_ItemOfInput, _LinqItem);
                    _ListOfLinq.Add(_LinqItem);
                }
                this.LinqContext.Log.DeleteAllOnSubmit<Log4Net.LinqToSqlContexts.Log>(_ListOfLinq);
                this.LinqContext.SubmitChanges();
            }
        ...
        {
            Log4Net.LinqToSqlContexts.Log _Only = GetLinqObjectByIdentifier(id);
            if (_Only != null)
            {
        ...
        /// </summary>
        /// <param name="id">The id.</param>
        /// <returns>an instance of <see cref="Log4Net.LinqToSqlContexts.Log"/> class, with same identifier, which is a IQueryable.</returns>
        private Log4Net.LinqToSqlContexts.Log GetLinqObjectByIdentifier(Log4Net.EntityContracts.ILogIdentifier id)
        {
            Func<Log4Net.LinqToSqlContexts.Log, bool> m_Predicate = (Log4Net.LinqToSqlContexts.Log t) =>
            {
                return Log4Net.EntityContracts.ILogIdentifierHelper.Equals<Log4Net.EntityContracts.ILogIdentifier, Log4Net.LinqToSqlContexts.Log>(id, t);
            };

            return this.LinqContext.Log.SingleOrDefault<Log4Net.LinqToSqlContexts.Log>(m_Predicate);
        }
