...
namespace Log4Net.EntityFrameworkDAL
{
        ...
        : Log4Net.DALContracts.DataAccessLayerFactoryContract
    {
        ...
        /// <summary>
        /// method to create an data access layer class instance of <see cref="Log4Net.DALContracts.ILogRepository"/>
        /// </summary>
        /// <returns>a new instance of <see cref="Log4Net.DALContracts.ILogRepository"/>.</returns>
        public Log4Net.DALContracts.ILogRepository CreateDALInstanceOfLog()
        {
            return new Log4Net.EntityFrameworkDAL.LogRepository(new Log4Net.EntityFrameworkContext.Log4NetEntities());
        }
